 ...
 * @date 14-6-20
 */
public class ActivityTaskA extends Activity implements Constant {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mBtn1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent _intent = new Intent(ActivityTaskA.this, ActivityTaskA.class);
        ...
        mBtn2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent _intent = new Intent(ActivityTaskA.this, ActivityTaskB.class);
                startActivity(_intent);
            }
        });
    }
