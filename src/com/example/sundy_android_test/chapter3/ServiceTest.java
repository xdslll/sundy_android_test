 ...
 * @date 14-6-21
 */
public class ServiceTest extends Activity implements Constant {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button _btnStartActivity = new Button(this);
        ...
        _btnStartActivity.setText("Start ServiceTest2");
        ...
        _el.addView(_btnStartActivity);
        _btnStartService.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mIntent = new Intent(ServiceTest.this, SamService.class);
        ...
        _btnStartIntentService.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mIntent = new Intent(ServiceTest.this, SamIntentService.class);
                startService(mIntent);
            }
        });
        ...
        _btnStartActivity.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(ServiceTest.this, ServiceTest2.class));
            }
        });
    }
